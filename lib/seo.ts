...
export const businessInfo = {
  ...
  description: "Профессиональная установка пластиковых окон и дверей в Лельчицах и Гомельской области. Качественные ПВХ конструкции, быстрый монтаж, гарантия качества.",
  phone: "+375293423221",
...
export const defaultMetadata: Metadata = {
  title: {
    default: "Окна и двери ПВХ в Лельчицах | Установка пластиковых окон",
    template: "%s | Окна и двери ПВХ Лельчицы"
  },
  ...
  openGraph: {
    ...
    title: "Окна и двери ПВХ в Лельчицах | Качественная установка",
    description: businessInfo.description,
    images: [
      {
  ...
  twitter: {
    ...
    title: "Окна и двери ПВХ в Лельчицах",
    description: businessInfo.description,
...
export const pageMetadata = {
  home: {
    title: "Окна и двери ПВХ в Лельчицах | Профессиональная установка",
    description: "Качественные пластиковые окна и двери в Лельчицах. Быстрая установка, гарантия качества. Звоните +375293423221. Работаем без выходных.",
    keywords: "пластиковые окна Лельчицы, установка окон, двери ПВХ, остекление балконов",
  },
  calculator: {
    ...
    keywords: "калькулятор окон, стоимость пластиковых окон, расчет цены окон Лельчицы",
  },
  portfolio: {
    title: "Наши работы | Примеры установки окон и дверей в Лельчицах",
    description: "Посмотрите примеры наших работ по установке пластиковых окон и дверей в Лельчицах и Гомельской области. Фото реальных объектов.",
    keywords: "примеры работ окна, фото установки окон Лельчицы, портфолио оконной компании",
  },
}
