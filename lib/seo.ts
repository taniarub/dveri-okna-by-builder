...
export const businessInfo = {
  ...
  description: "ПКачественные окна и двери ПВХ по доступным ценам с бесплатной доставкой по РБ. Качественные ПВХ конструкции, быстрый монтаж, гарантия качества.",
  phone: "+375293423221",
...
export const pageMetadata = {
  home: {
    title: "Окна и двери ПВХ",
    description: "Качественные пластиковые окна и двери. БГарантия качества. Звоните +375293423221. Работаем без выходных.",
