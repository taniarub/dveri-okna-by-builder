    ...
    <section id="contact" className="bg-white py-6 md:py-8">
      <div className="container">
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">Свяжитесь с нами</h2>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div 
            ref={sectionRef}
            className="opacity-0 transition-all duration-1000 bg-white p-6 md:p-8 rounded-lg"
          >
            ...
            <div className="mt-6 pt-4">
              <h4 className="text-center font-semibold text-lg text-gray-900 mb-3">Мы в соцсетях</h4>
